  ...
  addEventListeners() {
    ...
    player.addEventListener('loadedmetadata', () => {
      ...
      if (onLoadedMetadata) {
        ...
        onLoadedMetadata({
          textTracks: player.textTracks.map(textTrack => fromNativeTextTrack(textTrack)),
          audioTracks: player.audioTracks.map(audioTrack => fromNativeMediaTrack(audioTrack)),
          videoTracks: player.videoTracks.map(videoTrack => fromNativeMediaTrack(videoTrack)),
